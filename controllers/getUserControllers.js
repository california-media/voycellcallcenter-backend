        ...
        data: {
          ...
          accounts: {
            ...
            crm: [
              ...
              {
                type: "HubSpot",
                isConnected: user.hubspot?.isConnected || false,
                userId: user.hubspot?.userId || null,
                email: user.hubspot?.email || null,
                accessToken: user.hubspot?.accessToken || null,
                refreshToken: user.hubspot?.refreshToken || null,
